...
insert into produto(nomeproduto, descricao, preco,idfoto) values('Canon EOS250D','Câmera Canon EOS 250D Kit (EF-S 18-55mm DC III) - Preto Faça belas fotos e filmes ',1500.00,1);
...
idfoto int not null
  ...
  ALTER TABLE `dbphomo`.`itenspedido` 
 ADD CONSTRAINT `fk_itens_pk_acessorio`
   FOREIGN KEY (`idacessorio`)
   REFERENCES `dbphomo`.`acessorio` (`idacessorio`)
   ON DELETE NO ACTION
   ON UPDATE NO ACTION;
  
  
  -- //////////////////////////////////////////////////
  insert into foto(foto1 ,foto2, foto3, foto4) values ('lentef50mmcanon1.jpg1.png','lentef50mmcanon1.jpg.png','lentef50mmcanon1.jpg3.png','Clentef50mmcanon1.jpg4.png');
  insert into acessorio(nomeacessorio, descricao, preco,idfoto) values('Lente Canon 50mm','pequena, leve, nítida, rápida e silenciosa',1000.00,1);
  
  select * from acessorio; 
       
       -- teste detalhe acessorio api php
select a.idacessorio, a.nomeacessorio, a.descricao, a.preco, f.foto1,f.foto2,f.foto3,foto4 from acessorio a inner join foto f on a.idfoto=f.idfoto where idacessorio='1';
       
       -- código detalhe acessorio api php
"select a.idacessorio, a.nomeacessorio, a.descricao, a.preco, f.foto1,f.foto2,f.foto3,foto4 from acessorio a inner join foto f on a.idfoto=f.idfoto where idacessorio=:id";
