...
/*
O arquivo foto.php foi será incluido para que a classe endereco
...
/*
A estrutra while(equanto) realiza a busca de todos endereco cadastrados
...
*/
    ...
    header("HTTP/1.0 400");
    echo json_encode(array("mensagem"=>"Não há endereços cadastradas"));
}
?>
