...
$historicopedido = new HistoricoPedido($db);

$data = json_decode(file_get_contents("php://input"));

$historicopedido->idcliente=$data->idcliente;


$rs = $historicopedido->listar();
...
if($rs->rowCount()>0){
    $historicopedido_arr["saida"] = array();
/*
...
*/
    ...
    "valorparcela"=> $valorparcela
        ...
        array_push($historicopedido_arr["saida"],$array_item);

    }

    header("HTTP/1.0 200");
    echo json_encode($historicopedido_arr);
}
else{
    header("HTTP/1.0 400");
